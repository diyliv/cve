...
type FindVulnerabilitiesResp struct {
	...
	Result []*Cve `protobuf:"bytes,1,rep,name=result,proto3" json:"result,omitempty"`
}
...
var file_proto_cve_cve_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
